  ...
  const services = [
    {
      ...
      description: "Crafting modern, responsive, and high-performance websites tailored to your business needs with cutting-edge technologies.",
      features: ["Responsive Design", "SEO Optimization", "Performance Tuning", "Modern Frameworks"],
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          <rect x="3" y="4" width="18" height="16" rx="2" className="fill-current opacity-20" />
    ...
    },
    {
      ...
      description: "Building user-friendly, scalable mobile applications for seamless experiences across iOS and Android platforms.",
      features: ["Cross-Platform", "Native Performance", "App Store Ready", "Push Notifications"],
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          <rect x="7" y="2" width="10" height="20" rx="2" className="fill-current opacity-20" />
          <rect x="10" y="18" width="4" height="2" rx="1" fill="currentColor" />
          <path d="M9 6h6M9 8h6M9 10h4" stroke="currentColor" strokeWidth={1.5} />
        </svg>
      ),
    ...
    },
    {
      ...
      description: "Enhancing efficiency with cutting-edge robotics and automation solutions for your industrial operations.",
      features: ["Industrial IoT", "Process Automation", "AI Integration", "Real-time Monitoring"],
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Implementing intelligent solutions with advanced AI and machine learning technologies for data-driven insights.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`
            ...
            ${showContent ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-4'}
          `}>
            Explore our comprehensive range of technology solutions designed to accelerate your business growth 
            and drive digital transformation with cutting-edge innovation.
          </p>
              ...
              >
                ...
                <div className="relative p-8">
                  ...
                  <div className="flex justify-center mb-6">
                    ...
                    `}>
                      <div className={`${accentClasses.text} transition-all duration-300`}>
                        {service.icon}
                      </div>
