...
const Clients = () => {
  ...
  return (
    <section className="max-h-screen h-screen bg-blue-400 dark:from-gray-950 dark:via-gray-900 dark:to-blue-950 px-4 sm:px-8 md:px-16 lg:px-20 py-12">
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-12">
          ...
          <p
            className="text-xl text-white font-serif font-semibold dark:text-white  max-w-2xl mx-auto"
            style={{ paddingTop: 20 }}
          >
            We are proud to collaborate with some of the world’s most
            recognizable brands and innovators.
          </p>
        </div>
        <div
          ...
          {clients.map((client, index) => {
            ...
            return (
              ...
              >
                ...
                <button className="bg-blue-400 text-white hover:bg-blue-600hover:text-black font-semibold py-2 px-6 rounded-lg shadow  dark:hover:bg-blue-600 dark:hover:text-black  transition-transform transition-colors duration-200 mt-2 group-hover:scale-105 group-hover:shadow-lg">
                  Trusted Partner
                </button>
              </div>
            );
