  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center text-center max-w-2xl w-full">
        <h1 className="text-4xl sm:text-5xl 2xl:text-[400px] animate-pulse font-extrabold mb-6 text-gray-800 dark:text-black leading-snug"
...
>
        ...
        <div
          className="bg-blue-500 hover:bg-blue-700 text-white dark:text-black w-40 sm:w-48 dark:bg-blue-700 hover:bg-blue-500 mb-8 px-6 py-3 text-lg rounded-lg shadow-lg mx-auto cursor-pointer transition"
        style={{marginTop:40}}
        >
          Get Started
        </div>
