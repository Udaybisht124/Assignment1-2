...
const Home = () => {
  ...
  return (
    ...
    >
      <div className="text-center max-w-2xl" style={{paddingTop:100}}>
        ...
        <p className="text-lg mb-8 my-10 animate-pulse font-bold text-gray-500 dark:text-black">
        ...
        <div
          ...
          style={{ marginLeft: 210, marginTop: 80}}
        >
          Get Started
        </div>
      </div>
